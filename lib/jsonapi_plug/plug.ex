defmodule JSONAPIPlug.Plug do
  ...
  ```
  plug JSONAPIPlug.Plug, api: MyApp.API, resource: MyApp.MyView
  ```
  ...
  You can then use the contents of the struct to load data and call `JSONAPIPlug.View.render/5`
  or the render function generated by `use JSONAPIPlug.View` to generate responses and render
  them.
